...
public class LogicalSeed {
    ...
    public static int[] getSeed(int var0) throws IndexOutOfBoundsException {
        return seed[var0 - 1];
    }

    public static int getSeed(int var0, int var1) throws IndexOutOfBoundsException {
        return seed[var0 - 1][var1];
    }
